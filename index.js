...
class ProjectManager extends Instructor{
  constructor({name, age, location, favLanguage, catchPhrase, gradClassName, favInstructor}){
    super({name, age, location, favLanguage, catchPhrase, gradClassName, favInstructor})
